    ...
    return (
        <div className="flex flex-col min-h-screen bg-off-white">
            ...
            <div className="grid grid-cols-5">
                <div className="bg-ruby group inline-block fixed w-80">
                    <nav className="flex px-3 py-2 dropdown-menu group inline-flex items-center">
                        <ul className="space-y-2 hidden group-hover:block bg-ruby pt-4 pb-6">
            ...
            <main className="flex flex-col items-center justify-center flex-1 px-20 text-center">
                <div className="flex border-solid border-8 border-ruby rounded px-60 py-8 m-10">
                    <form action="" className="">
                        ...
                        <div className="px-32 pt-4">
                            <button className="justify-right block w-32 py-3 text-off-white font-bold bg-ruby rounded shadow-md focus:ring-2 hover:bg-opacity-90">Feed</button>
                        </div>
                    </form>
                </div>
                <div className="space-y-6">
                <div className="flex border-solid border-4 border-dark-blue px-60 py-8 rounded">
                    FEED1
                </div>
                <div className="flex border-solid border-4 border-dark-blue px-60 py-8 rounded">
                    FEED2
